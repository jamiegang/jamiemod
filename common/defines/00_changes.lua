...
NDefines.NCountryMONARCH_MIN_SKILL = 1,
NDefines.NCountryPROSPERITY_INCREASE_SIZE= 2,
NDefines.NCountryESTATE_PROVINCE_HAPPINESS_DECREASE = 3.0,
NDefines.NCountryMAX_IDEA_GROUPS_FROM_SAME_CATEGORY = 0.4,
NDefines.NEconomyDEBASE_MAX_CORRUPTION = 30,
NDefines.NEconomyBANKRUPTCY_PROVINCE_DEVASTATION_GAIN = 20,

NMilitary = {
	SLACKEN_AP_DROP = 0.05,
	SLACKEN_MANPOWER_INCREASE = 1.5,
	BASE_MP_TO_MANPOWER = 0.25,
	NOMAD_PLAINS_SHOCK_BONUS = 0.10, 				
	NOMAD_NON_PLAINS_SHOCK_PENALTY = -0.0,
	NAVAL_CASUALTY_MIN_MORALE_DAMAGE = 0.2,
	CREATE_JANISSARIES_MIL_COST = 8,
